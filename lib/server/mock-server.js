...
var MockServer = /** @class */ (function () {
    ...
    MockServer.prototype.allRoutesHandler = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var scope, matchedAndUnresolved, origRes, capturedInterceptor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        debugger;
                        ...
                        if (!!matchedAndUnresolved) return [3 /*break*/, 2];
                        if (!this.proxyEnabled) {
                            throw 'Not found interceptor';
                        }
                        return [4 /*yield*/, node_fetch_1.default(req.url, {
                                method: req.method,
                                body: req.body
                            })];
                    case 1:
                        origRes = _a.sent();
                        capturedInterceptor = new http_interceptor_builder_1.HttpInterceptorBuilder()
                            .match('method-exact', req.method)
                            .andMatch('path-exact', req.path)
                            .resolveWith(function (_, res, data) {
                        ...
                        return [2 /*return*/];
                    case 2: return [2 /*return*/, matchedAndUnresolved.resolve(req, res)];
                }
            });
        });
    };
