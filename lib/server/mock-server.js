...
var MockServer = /** @class */ (function () {
    ...
    MockServer.prototype.allRoutesHandler = function (req, res) {
        var scope = req.query['apate-scope'];
        var matchedAndUnresolved = this.interceptorsQueue.find(function (interceptor) { return !interceptor.isResolved && interceptor.match(req) && scope === interceptor.scope; });
