...
var MockServer = /** @class */ (function () {
    ...
    MockServer.prototype.queueInterceptor = function (interceptor) {
        this.interceptorsQueue.push(interceptor);
    };
    MockServer.prototype.allRoutesHandler = function (req, res) {
        var matchedAndUnresolved = this.interceptorsQueue.find(function (interceptor) { return !interceptor.isResolved && interceptor.match(req); });
