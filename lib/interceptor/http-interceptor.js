...
var deserialize_any_resolver_1 = require("../resolver/deserialize-any-resolver");
var HttpInterceptor = /** @class */ (function () {
    ...
    HttpInterceptor.deserialize = function (serialized) {
        ...
        var resolver = deserialize_any_resolver_1.deserializeAnyResolver(serialized.resolver);
