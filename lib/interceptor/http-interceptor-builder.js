...
var HttpInterceptorBuilder = /** @class */ (function () {
    ...
    HttpInterceptorBuilder.prototype.resolveWith = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        this.resolver = new (http_resolver_1.HttpResolver.bind.apply(http_resolver_1.HttpResolver, __spreadArray([void 0], __read(params))))();
        return this;
    };
