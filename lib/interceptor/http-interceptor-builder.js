...
var http_matcher_1 = require("../matcher/http-matcher");
var HttpInterceptorBuilder = /** @class */ (function () {
    function HttpInterceptorBuilder(commitHandler, scope) {
        var _this = this;
        if (commitHandler === void 0) { commitHandler = function (interceptor) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); }; }
        ...
        this.resolve = function () {
            ...
            _this.resolver = _this.matchArgsToResolver(args);
            return _this;
        };
        this.matcher = new logical_matcher_1.AndMatcher();
        this.matchArgsToMatcher = function (args) {
            if (typeof args[0] === 'function') {
                return new matcher_1.CustomMatcher(args[0], args[1]);
            }
            else {
                return new http_matcher_1.HttpMatcher(args[0]);
            }
        };
        this.matchArgsToResolver = function (args) {
            if (typeof args[0] === 'function') {
                return new http_resolver_1.HttpCustomResolver(args[0], args[1]);
            }
            else {
                return new http_resolver_1.HttpResolver(args[0]);
            }
        };
    }
    HttpInterceptorBuilder.prototype.commit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        interceptor = this.buildInterceptor();
                        return [4 /*yield*/, this.commitHandler(interceptor)];
                    case 1:
                        _a.sent();
    ...
    HttpInterceptorBuilder.prototype.buildInterceptor = function () {
        ...
        return new http_interceptor_1.HttpInterceptor(this.matcher, this.resolver, this.scope);
    };
